...
= 3.2.12 =
* Fixed a bug with the Bulk Add button
...
= 3.2.8 =
* Fixed and issue with the Print Button
...
= 3.1.5 =
* Fixed issue with the print button when inserting an existing Recipe in a post
* Fixed issue with the post title in Recipe post type
...
* Fixed a bug with Elementor activation

= 3.1.2 =
* Fixed a bug with recipe title
* Add link to edit the recipe block post
